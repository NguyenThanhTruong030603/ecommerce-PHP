...
if ($start_date && $end_date) {
    ...
    $where_clause_revenue = "AND DATE(created_at) BETWEEN :start_date AND :end_date";
} elseif ($start_date) {
    $where_clause = "AND DATE(o.created_at) >= :start_date";
    $where_clause_revenue = "AND DATE(created_at) >= :start_date";
} elseif ($end_date) {
    $where_clause = "AND DATE(o.created_at) <= :end_date";
    $where_clause_revenue = "AND DATE(created_at) <= :end_date";
}
